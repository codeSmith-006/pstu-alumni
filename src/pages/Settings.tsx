    ...
    <div className="min-h-screen bg-[#1E1E1E] pt-20 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-4">Settings</h1>
          <p className="text-[#A9A9A9] text-lg">Manage your account preferences</p>
        </div>
        ...
        <div className="bg-[#2A2A2A] rounded-lg border border-[#3A3A3A] p-12 text-center">
          ...
          <p className="text-[#A9A9A9] text-lg mb-8 max-w-2xl mx-auto">
            Update your profile information, notification preferences, privacy settings, and manage your account security.
          </p>
